(function(rc) {
	...
	rc.data = [
		...
		},
		{
			...
			"openingHours": [{
				...
				"tI": [{
					...
					"from": "13:00",
					"to": "20:00",
					"wM": [[780, 1200], [2220, 2640], [3660, 4080], [5100, 5520], [6540, 6960]]
				}]
			}, {
				"cW": [{
					"weekday": "Sa",
		...
		},
		{
			...
			"openingHours": [{
				...
				"tI": [{
					...
					"from": "12:00",
					"to": "19:00",
					"wM": [[720, 1140], [2160, 2580], [3600, 4020], [5040, 5460], [6480, 6900]]
				}]
			}, {
				"cW": [{
					"weekday": "Sa",
		...
		},
		{
			...
			"openingHours": [{
				...
				"tI": [{
					...
					"from": "13:00",
					"to": "16:00",
					"wM": [[780, 960], [2220, 2400], [3660, 3840], [5100, 5280], [6540, 6720]]
				}]
			}, {
				"cW": [{
					"weekday": "Sa",
		...
		},
		{
			...
			"openingHours": [{
				...
				"tI": [{
					...
					"from": "10:00",
					"to": "18:00",
					"wM": [[600, 1080], [2040, 2520], [3480, 3960], [4920, 5400], [6360, 6840]]
				}]
			}, {
				"cW": [{
					"weekday": "Sa",
		...
		},
		{
			...
			"openingHours": [{
				...
				"tI": [{
					...
					"from": "09:00",
					"to": "12:00",
					"wM": [[540, 720], [1980, 2160], [3420, 3600], [4860, 5040], [6300, 6480]]
				}, {
					"microdata": "Mo-Fr 12:30-17:00",
					"from": "12:30",
					"to": "17:00",
					"wM": [[750, 1020], [2190, 2460], [3630, 3900], [5070, 5340], [6510, 6780]]
				}]
			}, {
				"cW": [{
					"weekday": "Sa",
		...
		},
		{
			...
			"openingHours": [{
				...
				"tI": [{
					...
					"from": "13:00",
					"to": "17:00",
					"wM": [[780, 1020], [2220, 2460], [3660, 3900], [5100, 5340], [6540, 6780]]
				}]
			}, {
				"cW": [{
					"weekday": "Sa",
		...
		},
		{
			...
			"keyValues": {
				"city": "Bad Friedrichshall - Kochendorf",
		...
		},
		{
			...
			"openingHours": [{
				...
				"tI": [{
					...
					"from": "07:45",
					"to": "12:00",
					"wM": [[465, 720], [1905, 2160], [3345, 3600], [4785, 5040], [6225, 6480]]
				}, {
	...
	rc.filteredData = function(centerPos) {
		...
		if (centerPos) {
			...
			comparator = function(r1, r2) {
				var d1 = r1.keyValues.city + ' ' + r1.keyValues.name;
				var d2 = r2.keyValues.city + ' ' + r2.keyValues.name;
